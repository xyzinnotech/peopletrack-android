...
public class RssiBinder extends BaseViewBinder<RssiItem> {
    ...
    public void bind(BaseViewHolder<RssiItem> holder, RssiItem item) {
        ...
        actualHolder.getcount().setText(formatcount(item.getcount()));
        actualHolder.getvalue().setText(formatcount(item.getvalue()));
    }
    ...
    private String formatRssi(final double rssi) {
        return getContext().getString(R.string.formatter_meters, String.valueOf(rssi));
    }
    ...
    private String formatcount(final double rssi) {
        return getContext().getString(R.string.formatter_none, rssi);
    }

    private String formatcount(final String rssi) {
        return getContext().getString(R.string.formatter_none, rssi);
    }
