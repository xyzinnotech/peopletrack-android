...
/*protected*/ final class RecyclerViewCoreFactory {
    ...
    public static RecyclerViewBinderCore create(final Context context, final Navigation navigation, GetDeviceInfo getDeviceInfo) {
        final RecyclerViewBinderCore core = new RecyclerViewBinderCore();

        core.add(new IBeaconBinder(context, navigation,getDeviceInfo), IBeaconHolder.class, R.layout.list_item_device_ibeacon);
