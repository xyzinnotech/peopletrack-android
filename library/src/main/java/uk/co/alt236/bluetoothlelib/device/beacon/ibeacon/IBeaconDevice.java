...
public class IBeaconDevice extends BluetoothLeDevice implements BeaconDevice{
    ...
    public double getAccuracy() {
        //kmlf=new KalmanFilters();
        //ArmaFillters arf=new ArmaFillters();
        return IBeaconUtils.calculateAccuracy(
              // getCalibratedTxPower(),kmlf.applyFilter((double) getRssi())
               // getCalibratedTxPower(),arf.addMeasurement(getRssi())
                getCalibratedTxPower(),getRssi()
        );
